...
const config = {
    ...
    port: parseInt(process.env.PORT || '5000', 10),    //10 represents decimal base for parsing the port number
    ...
    //jwt
    jwt: {
        secret: process.env.JWT_SECRET || "HOW_IS_LIFE_GOING__BAS_CHAL_RAHA_HAI",
